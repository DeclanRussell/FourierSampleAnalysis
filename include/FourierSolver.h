...
public:
    ...
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief mutator to the range of our axis
    /// @param _r - desired range of our axis (float)
    //----------------------------------------------------------------------------------------------------------------------
    inline void setAxisRange(float _r){m_axisRange = _r;}
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief accessor to the range of our axis
    /// @return range of our axis (float)
    //----------------------------------------------------------------------------------------------------------------------
    inline float getAxisRange(){return m_axisRange;}
    //----------------------------------------------------------------------------------------------------------------------
...
#ifdef USE_PTHREADS
    //----------------------------------------------------------------------------------------------------------------------
    /// Our per sample analysis function to be run in parallel with pthreads
    //----------------------------------------------------------------------------------------------------------------------
    void perSampleAnalysis(int _x,int _y);
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief our argument structure for our function
    //----------------------------------------------------------------------------------------------------------------------
    struct PSAArgs
    {
        FourierSolver* obj;
...
private:
#ifdef USE_PTHREADS
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief our pthreads wrapper function to launch our per sample functions in there threads
    //----------------------------------------------------------------------------------------------------------------------
    static void *psaWrapper(void *_args)
    {
        FourierSolver::PSAArgs *args = (FourierSolver::PSAArgs*)_args;
        args->obj->perSampleAnalysis(args->x,args->y);
        return 0;
    }
    //----------------------------------------------------------------------------------------------------------------------
#endif
    ...
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief array of our pair-wise sample differentials used for our analysis
    //----------------------------------------------------------------------------------------------------------------------
